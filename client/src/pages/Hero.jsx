...
import { FaGithub, FaTwitter, FaDiscord, FaCode, FaCalendarAlt, FaUsers, FaLaptopCode, FaArrowRight } from 'react-icons/fa';


// Banner Component
const Banner = () => {
  return (
    <section id="home" className="bg-gradient-to-r from-blue-900 to-purple-900 text-white">
      <div className="container mx-auto px-6 py-20 flex flex-col md:flex-row items-center">
        <div className="md:w-1/2 flex flex-col items-start mb-16 md:mb-0">
          ...
          <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
            <button className="bg-blue-500 hover:bg-blue-600 text-white font-bold py-3 px-6 rounded-lg transition flex items-center">
              Join Community <FaArrowRight className="ml-2" />
            </button>
            <button className="bg-transparent hover:bg-white hover:text-blue-900 text-white font-bold py-3 px-6 border-2 border-white rounded-lg transition">
              Learn More
            </button>
          </div>
        </div>
          ...
          {events.map((event, index) => (
            <div key={index} className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition">
              ...
              <div className="p-6">
                ...
                <button className="text-blue-500 font-medium hover:text-blue-700 transition flex items-center">
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {teamMembers.map((member, index) => (
            <div key={index} className="bg-white rounded-lg p-6 text-center shadow hover:shadow-lg transition">
              ...
              <div className="flex justify-center space-x-4">
                <a href={member.social.github} className="text-gray-600 hover:text-blue-500 transition">
                  <FaGithub className="text-xl" />
                </a>
                <a href={member.social.twitter} className="text-gray-600 hover:text-blue-500 transition">
...
const JoinUs = () => {
  return (
    <section id="join" className="py-20 bg-gradient-to-r from-blue-900 to-purple-900 text-white">
      <div className="container mx-auto px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4 mb-12">
            <a href="#" className="flex items-center justify-center bg-white text-blue-900 hover:bg-gray-100 font-bold py-3 px-6 rounded-lg transition">
...
export default DevXHubMainContent;